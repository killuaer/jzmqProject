...
@Repository
@Transactional
public class JcLogRunDao extends BaseDao {

	@PersistenceContext
	private EntityManager entityManager;

	
	public FundPage<JcLogRun> listJcLogRun(Map<String, Object> paramMap, PageRequest page) {
		StringBuilder hql = new StringBuilder();
		List<Object> paramList = new ArrayList<>();
		int i = 1;
		hql.append(" from JcLogRun a where  1=1 ");
